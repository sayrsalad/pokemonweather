...
let pokedexUrl = 'https://pokeapi.co/api/v2/pokedex/' + NATIONAL;
 ...
 */
 function displayPokemonInfo(id) {
	...
	.then(x => {
		...
		statLabel.textContent = capitalizeFirstLetter(obj.stat.name) + ": ";
		...
		.then(x => {
			...
			console.log(evoChain);
				...
				evoName.textContent = capitalizeFirstLetter(evo.species_name);
